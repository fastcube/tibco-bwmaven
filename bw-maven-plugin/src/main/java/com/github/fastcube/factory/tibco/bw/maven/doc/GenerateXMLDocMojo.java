 ...
 */
package io.github.fastcube.factory.tibco.bw.maven.doc;
...
import io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.Bwdoc;
import io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.Bwdoc.CalledProcesses;
import io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.Bwdoc.Labels;
import io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.ObjectFactory;
import io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.Process;
import io.github.fastcube.factory.tibco.bw.maven.source.AbstractProjectsListMojo;
import io.github.fastcube.factory.tibco.bw.maven.source.ProcessModel;
...
public class GenerateXMLDocMojo extends AbstractDocMojo {
	...
	public void processFile(File f) throws MojoExecutionException {
		...
		for (Label l : pd.getLabel()) {
			io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.Label label = new io.github.fastcube.factory.tibco.bw.maven.doc.jaxb.Label();
